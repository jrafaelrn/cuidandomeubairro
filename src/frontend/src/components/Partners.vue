<template>
  <div class="c-partners">
    ...
    <div class="c-partners__list lg:flex justify-between">
      <!-- # COMMENT TCC 2023 #
      <div class="p-6 mx-3 lg:w-1/5 h-32 mb-2 flex items-center justify-center border-2 rounded-md text-border-base">
        <a href="">
          <img
      ...
      <div class="p-6 mx-3 lg:w-1/5 h-32 flex items-center justify-center border-2 rounded-md text-border-base">
        <a href="">
    ...
    <!-- # COMMENT TCC 2023 #
    <h2 class="c-partners__title text-center text-neutral-base text-2xl font-bold my-10">
      Apoio
    </h2>
