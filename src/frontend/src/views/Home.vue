  ...
  <div>
    ...
    <div class="home pb-20 -mt-3">
      ...
      <div class="c-home__distribution-data-table container mx-auto py-20 -mt-2">
        ...
        <p class="text-neutral-light text-center text-xl pb-3">Na tabela abaixo estão os gastos por Função Governo.</p>
        <dynamic-table />
        <div class="container mx-auto flex justify-center">
          ...
          href="https://transparencia.tce.sp.gov.br/sites/default/files/conjunto-dados/despesas-2023.zip"
          target="_blank">
