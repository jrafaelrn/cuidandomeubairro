...
CREATE TABLE IF NOT EXISTS cmb.f_despesa (
    ...
    ds_programa character varying(200),
    cd_acao character varying(30),
    ds_acao character varying(200),
    id_despesa_detalhe character varying(30) NOT NULL,
    ds_orgao character varying(200),
    tp_despesa character varying(30),
    nr_empenho character varying(30) NOT NULL,
    tp_identificador_despesa character varying(50),
    nr_identificador_despesa character varying(200),
    ds_despesa character varying(500),
    dt_emissao_despesa date NOT NULL,
    valor_despesa numeric(15,2) NOT NULL,
    ds_funcao_governo character varying(200),
    ds_subfuncao_governo character varying(200),
    ds_fonte_recurso character varying(200),
    ds_cd_aplicacao_fixo character varying(200),
    ds_modalidade_lic character varying(50),
    ds_elemento character varying(200),
    historico_despesa character varying(5000) NOT NULL,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS cmb.tabela_localizacoes AS
    SELECT DESP.historico_despesa,
        ...
        DESP.dt_emissao_despesa
    FROM cmb.f_despesa AS DESP
	WHERE (DESP.latitude =  '') is not true;